...
Selamat datang di repositori portofolio resmi **Nayla Azzahra R**, mahasiswi **Teknik Komputer** (Kelas C - Angkatan 2025). Portofolio ini dibangun sebagai implementasi praktis mata kuliah **Pemrograman Web**, memadukan logika rekayasa web, desain antarmuka *Pink Aesthetic*, serta ekspresi minat dan bakat dalam **Seni Tari Tradisional Nusantara**.
...
3. **Pementasan Tari Kipas Nusantara** – Formasi dinamis dan sinkronisasi tim pementasan.
4. **Tari Kipas Merah & Emas** – Penampilan tari kipas dengan energi ekspresif.
